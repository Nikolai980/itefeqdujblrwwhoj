...
function showAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            <b><a href="https://github.com/avtostart" class="umami--click--github" target="_blank">Private Source</a></b> project
            <br/><br />
            <button class="pulsate umami--click--sponsors" onclick="window.open('https://github.com/sponsors/r4club?o=esb')"><i class="fas fa-heart"></i> Support</button>
            <br /><br />
            Author: <a href="https://www.linkedin.com/in/r4club/" class="umami--click--linkedin" target="_blank"> R4 Club</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
